...
time native-image \
  -J-Xmx4G \
  --trace-class-initialization=java.rmi.dgc.VMID,java.rmi.server.ObjID,com.sun.jmx.mbeanserver.MXBeanLookup,com.sun.jmx.mbeanserver.Introspector,sun.rmi.transport.ObjectTable,sun.reflect.misc.Trampoline,jdk.management.jfr.SettingDescriptorInfo,java.rmi.server.UID,com.sun.jmx.defaults.JmxProperties,com.sun.jmx.remote.util.EnvHelp,com.sun.jmx.mbeanserver.MBeanInstantiator
  -H:Name=$ARTIFACT \
