...
import com.java.xue.config.OAuth2ClientProperties;
import com.java.xue.config.OAuth2ServerProperties;
import com.java.xue.constants.GrantType;
import com.java.xue.domain.dto.TokenDTO;
import com.java.xue.domain.entity.ClientUser;
import com.java.xue.domain.vo.UserInfo;
...
public class TokenService {
  ...
  public String getToken(String code) throws UnsupportedEncodingException {
    ...
    if (exchange.getStatusCode().is2xxSuccessful()) {
      log.info("Request success body [{}]", exchange.getBody());
  ...
  public void tryGetUserInfo(ModelAndView mv, ClientUser currentUser) {
    ...
    RequestEntity<MultiValueMap<String, String>> requestEntity
            = new RequestEntity<>(headers, HttpMethod.GET, URI.create("http://127.0.0.1:8086/user/jack"));
